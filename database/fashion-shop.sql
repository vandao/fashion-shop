...
--
-- Host: localhost
-- Generation Time: Aug 02, 2013 at 10:30 PM
...
--
-- Dumping data for table `fs_affiliate`
--
...
--
-- Dumping data for table `fs_affiliate_transaction`
--
...
--
-- Dumping data for table `fs_attribute`
--
...
--
-- Dumping data for table `fs_attribute_description`
--
...
--
-- Dumping data for table `fs_attribute_group`
--

INSERT INTO `fs_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Dumping data for table `fs_attribute_group_description`
--
...
--
-- Dumping data for table `fs_banner`
--
...
--
-- Dumping data for table `fs_banner_image_description`
--
...
--
-- Dumping data for table `fs_category_description`
--
...
--
-- Dumping data for table `fs_category_to_layout`
--
...
--
-- Dumping data for table `fs_category_to_store`
--
...
INSERT INTO `fs_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
--
-- Dumping data for table `fs_coupon`
--
...
--
-- Dumping data for table `fs_coupon_product`
--
...
--
-- Dumping data for table `fs_customer_group`
--
...
--
-- Dumping data for table `fs_customer_group_description`
--
...
--
-- Dumping data for table `fs_customer_ip_blacklist`
--
...
--
-- Dumping data for table `fs_customer_reward`
--
...
--
-- Dumping data for table `fs_download_description`
--
...
INSERT INTO `fs_extension` (`extension_id`, `type`, `code`) VALUES
(23, 'payment', 'cod'),
(22, 'total', 'shipping'),
(57, 'total', 'sub_total'),
(58, 'total', 'tax'),
...
--
-- Dumping data for table `fs_geo_zone`
--
...
--
-- Dumping data for table `fs_information_description`
--
...
--
-- Dumping data for table `fs_information_to_layout`
--
...
--
-- Dumping data for table `fs_information_to_store`
--

INSERT INTO `fs_information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0);
...
--
-- Dumping data for table `fs_length_class`
--

INSERT INTO `fs_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- Dumping data for table `fs_length_class_description`
--
...
--
-- Dumping data for table `fs_manufacturer`
--
...
--
-- Dumping data for table `fs_manufacturer_to_store`
--
...
--
-- Dumping data for table `fs_option`
--

INSERT INTO `fs_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 2),
(2, 'checkbox', 3),
(4, 'text', 4),
(5, 'select', 1),
...
--
-- Dumping data for table `fs_option_description`
--
...
--
-- Dumping data for table `fs_option_value`
--
...
--
-- Dumping data for table `fs_option_value_description`
--
...
--
-- Dumping data for table `fs_order_download`
--
...
--
-- Dumping data for table `fs_order_fraud`
--
...
--
-- Dumping data for table `fs_order_misc`
--
...
--
-- Dumping data for table `fs_order_option`
--
...
--
-- Dumping data for table `fs_order_voucher`
--
...
--
-- Dumping data for table `fs_product_to_category`
--
...
--
-- Dumping data for table `fs_product_to_download`
--
...
--
-- Dumping data for table `fs_product_to_layout`
--
...
--
-- Dumping data for table `fs_product_to_store`
--
...
--
-- Dumping data for table `fs_return`
--
...
--
-- Dumping data for table `fs_return_action`
--
...
--
-- Dumping data for table `fs_return_history`
--
...
--
-- Dumping data for table `fs_return_reason`
--
...
--
-- Dumping data for table `fs_return_status`
--
...
--
-- Dumping data for table `fs_review`
--
...
--
-- Dumping data for table `fs_stock_status`
--
...
--
-- Dumping data for table `fs_store`
--
...
--
-- Dumping data for table `fs_tax_rate_to_customer_group`
--
...
--
-- Dumping data for table `fs_voucher`
--
...
--
-- Dumping data for table `fs_voucher_history`
--
...
--
-- Dumping data for table `fs_voucher_theme`
--

INSERT INTO `fs_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Dumping data for table `fs_voucher_theme_description`
--
...
--
-- Dumping data for table `fs_weight_class`
--

INSERT INTO `fs_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- Dumping data for table `fs_weight_class_description`
--
...
INSERT INTO `fs_zone` (`zone_id`, `country_id`, `code`, `name`, `status`) VALUES
